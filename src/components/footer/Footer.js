    ...
    <footer>
        <div className={classes.foot}>
            <div className={classes.footer_logo}>
                ...
                <h5>Address: <span>udgyduuyvsvvcuvvs,nbhbcdjncbbhcb</span></h5>
                <h5>Phone: <span> +234 812 345 7569 , +01 564 545 3567 </span></h5>
                <h5>Email: <span>compactpay@mail.com</span></h5>
