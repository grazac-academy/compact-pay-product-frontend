...
const Home = () => {
  return (
    ...
    <div className={classes.mobile}> 
        <h2 className={classes.H2text}>Transfer money online at your own conveniency</h2>
        <div className={classes.iphone}>
            <img src={iphone} alt="iphone" />
        </div>
        <div className={classes.transfer}>
            <h2>Transfer money online at your own conveniency</h2>
            <p>Download our app for free to transfer money online across the border at your own conviniency. Track your payments and view your transaction history anytime and anywhere.</p>
