    ...
    <div className={classes.BenPage}>
      <div className={classes.Personal}>
        ...
        <div className={classes.New}>
          <div className={classes.createBen}>
            ...
            <p>
              Enter receiver's bank account details to continue Enter receiver's
              bank account <br></br>details to continue
            </p>
      ...
      <div className={classes.list}>
        ...
        <div className={classes.page}>
          <Pagination>
            <MdNavigateNext className={classes.prev} />
          </Pagination>
          <Pagination>
          ...
          <Pagination>
            <MdNavigateNext className={classes.next} />
          </Pagination>
        </div>
      </div>
